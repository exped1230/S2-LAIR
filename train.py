...
def get_config():
    ...
    parser.add_argument('--mixed_loss_ratio', type=float, default=1.0)
    ...
    parser.add_argument('--data_dir', type=str, default='/home/ubuntu15/jgl/datasets/Adience')
    parser.add_argument('--test_data_dir', type=str, default='/home/ubuntu15/jgl/datasets/Adience/test')
    ...
    # config file
    parser.add_argument('--c', type=str, default='/home/ubuntu14/jgl/projects/Semi-supervised-learning/config/classic_cv/main/main_adience_1600_2.yaml')
...
def main(args):
    ...
    '''
    #print(args.num_train_iter,args.epoch)
    ...
    str_cur_time = str(cur_time.year) + str(cur_time.month) + str(cur_time.day) + str(cur_time.hour) + str(cur_time.minute) + str(cur_time.second)
    args.save_name = args.save_name + '_' + str_cur_time
