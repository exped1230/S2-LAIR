...
mean['lamem'] = [0.485, 0.456, 0.406]

std['cifar10'] = [0.229, 0.224, 0.225]
std['cifar100'] = [x / 255 for x in [68.2, 65.4, 70.4]]
std['lamem'] = [0.229, 0.224, 0.225]
...
def score2label(dmos):
        ...
        if 0.8<dmos<=1:
           return 3
def get_lamem(args, alg, name, num_labels, num_classes, data_dir='/home/ubuntu/wwc/lamem', include_lb_to_ulb=True):
    data = []
    target = []
    with open(data_dir, 'r') as file:
        ...
        for line in file:
            ...
            data.append('/home/ubuntu/wwc/lamem/images/'+image)
    ...
    transform_weak = transforms.Compose([
        ...
        transforms.ToTensor(),
        transforms.Normalize(mean['lamem'], std['lamem'])
    ])
    ...
    with open(args.test_data_dir, 'r') as file:
        ...
        for line in file:
            ...
            image = line[0]
            score = float(line[1].rstrip("\n"))
            test_data.append('/home/ubuntu/wwc/lamem/images/'+image)
