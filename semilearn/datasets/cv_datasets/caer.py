...
mean['caer'] = [0.485, 0.456, 0.406]

std['cifar10'] = [0.229, 0.224, 0.225]
std['cifar100'] = [x / 255 for x in [68.2, 65.4, 70.4]]
std['caer'] = [0.229, 0.224, 0.225]


def get_caer(args, alg, name, num_labels, num_classes, data_dir='./data', include_lb_to_ulb=True):
    ...
    transform_weak = transforms.Compose([
        ...
        transforms.ToTensor(),
        transforms.Normalize(mean['caer'], std['caer'])
    ])
